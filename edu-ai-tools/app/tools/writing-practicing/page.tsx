...
import { Paperclip, SendHorizonal, MessageSquare, Trash, Plus, PenTool } from "lucide-react";
...
export default function WritingPracticingArea() {
  const [messages, setMessages] = useState<Message[]>([
    { id: 1, role: "bot", content: "Hello! Ready to start your writing practice?" },
  ...
  const startNewPractice = () => {
    ...
    setMessages([{ id: 1, role: "bot", content: "Welcome to your new writing practice!" }]);
  };
    ...
    <div className="p-6 lg:p-8">
      ...
      <div className="mb-8">
        <div className="flex items-center space-x-3 mb-3">
          ...
          <h1 className="text-3xl font-bold text-foreground">Writing Practicing Area</h1>
        </div>
        <p className="text-lg text-muted-foreground">
          Practice your writing skills through simulated IELTS writing topics. You can type your answers here, or upload files, and
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your previous writing practicing sessions</CardDescription>
            </CardHeader>
